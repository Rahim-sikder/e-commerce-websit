...
<div class="container-fluid p-0">
   ...
   <div class="row">
      <div class="col-md-12 bg-secondary p-1 d-flex align-items-center">
         <div class="p-3 mx-5">
            <a href="#"><img src="../images/pineapple-juice.jpg" alt="" class="admin-img"></a>
            <p class="text-light text-center">Admin Name</p>
         </div>

          <div class="button text-center mx-5">
            <button><a href="insert_product.php" class="nav-link text-light bg-info my-2">Insert Products</a></button>
            ...
            <button><a href="index.php?insert_brand" class="nav-link text-light bg-info my-2">Insert Brands</a></button>
            <button><a href="" class="nav-link text-light bg-info my-2">View Brands</a></button>
...
<div class="bg-info p-3 text-center footer">
   <p>All right reserved @ - Designed By Rahim-2024</p>
</div>
